...
public enum gunTypes {
    USP(6, 30, 20, 13, 13, new ItemStack(Material.WOODEN_PICKAXE, 13), 2f, 1, "mcgo.weapons.pistolshot", "USP", "銏",1,0.05f),
    HK(12, 30, 20, 10, 10, new ItemStack(Material.STONE_PICKAXE, 10), 2f, 1, "mcgo.weapons.pistolshot", "HK", "銟", 1,.1f),
    DEAGLE(10, 40, 40, 7, 7, new ItemStack(Material.GOLDEN_PICKAXE, 7), 2f, 1, "mcgo.weapons.magnumshot", "Desert Eagle", "銎",1,.1f),
    //
